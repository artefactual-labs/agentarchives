...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_levels_of_description.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_collections_search.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_collections_search_no_results.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_listing_collections_search_spaces.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_listing_collections_sort.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_component_parent_with_top_level_parent.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_component_parent_with_non_top_level_parent.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_resource_children.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_resource_children_recursion_level_one.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_resource_component_children_at_max_recursion_level.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_collection_ids.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_find_collection_ids_search.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_count_collection_ids.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_count_collection_ids_search.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_identifier_exact_match.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_add_child_resource.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_add_child_resource_component.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_adding_child_with_note.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_delete_record_resource.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_edit_archival_object.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_edit_record_empty_note.yaml'))
...
@vcr.use_cassette(os.path.join(THIS_DIR, 'fixtures/atom', 'test_add_digital_object.yaml'))
